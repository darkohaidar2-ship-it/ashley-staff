...
export const initialData: any = {
    ...
    attendanceLogs: [
      { 
        ...
        type: 'هاتن (Check In)', 
        time: '2026-08-01 08:15:10', 
        distance: 'داخل کۆمپانیا (10m)', 
        selfieUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 300 300"><rect width="300" height="300" fill="%231e293b"/><circle cx="150" cy="110" r="50" fill="%2338bdf8"/><path d="M70 240 C70 170, 230 170, 230 240 Z" fill="%230284c7"/><text x="150" y="275" font-size="16" fill="white" text-anchor="middle" font-family="sans-serif">Darko Selfie Check-In</text></svg>', 
        status: 'verified', 
        createdAt: '2026-08-01 08:15:10' 
      },
      { 
        id: 'att-02', 
        employeeId: 'emp-02', 
        ...
        distance: 'داخل کۆمپانیا (12m)', 
        selfieUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 300 300"><rect width="300" height="300" fill="%230f172a"/><circle cx="150" cy="110" r="50" fill="%23f43f5e"/><path d="M70 240 C70 170, 230 170, 230 240 Z" fill="%23be123c"/><text x="150" y="275" font-size="16" fill="white" text-anchor="middle" font-family="sans-serif">Darko Selfie Check-Out</text></svg>', 
        status: 'verified', 
        createdAt: '2026-08-01 16:30:00' 
      },
      { 
        id: 'att-03', 
        employeeId: 'emp-05', 
        ...
        type: 'هاتن (Check In)', 
        time: '2026-08-03 08:30:00', 
        distance: 'داخل کۆمپانیا (15m)', 
        selfieUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 300 300"><rect width="300" height="300" fill="%231e293b"/><circle cx="150" cy="110" r="50" fill="%2310b981"/><path d="M70 240 C70 170, 230 170, 230 240 Z" fill="%23047857"/><text x="150" y="275" font-size="16" fill="white" text-anchor="middle" font-family="sans-serif">Imad Selfie Check-In</text></svg>', 
        status: 'verified', 
      ...
      { 
        ...
        name: 'عیماد سەباح نوری', 
        type: 'دەرچوون (Check Out)', 
        time: '2026-08-03 16:45:00', 
        distance: 'داخل کۆمپانیا (15m)', 
        selfieUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 300 300"><rect width="300" height="300" fill="%230f172a"/><circle cx="150" cy="110" r="50" fill="%23f43f5e"/><path d="M70 240 C70 170, 230 170, 230 240 Z" fill="%23be123c"/><text x="150" y="275" font-size="16" fill="white" text-anchor="middle" font-family="sans-serif">Imad Selfie Check-Out</text></svg>', 
        status: 'verified', 
      ...
      { 
        ...
        name: 'دارکۆ حەیدەر حسێن', 
        type: 'هاتن (Check In)', 
        time: '2026-08-08 08:20:00', 
        distance: 'داخل کۆمپانیا (8m)', 
        selfieUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 300 300"><rect width="300" height="300" fill="%231e293b"/><circle cx="150" cy="110" r="50" fill="%2338bdf8"/><path d="M70 240 C70 170, 230 170, 230 240 Z" fill="%230284c7"/><text x="150" y="275" font-size="16" fill="white" text-anchor="middle" font-family="sans-serif">Darko Selfie Check-In</text></svg>', 
        status: 'verified', 
        createdAt: '2026-08-08 08:20:00' 
      },
      { 
        id: 'att-06', 
        employeeId: 'emp-05', 
        name: 'عیماد سەباح نوری', 
        type: 'هاتن (Check In)', 
        time: '2026-08-10 08:28:00', 
        distance: 'داخل کۆمپانیا (12m)', 
        selfieUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 300 300"><rect width="300" height="300" fill="%231e293b"/><circle cx="150" cy="110" r="50" fill="%2310b981"/><path d="M70 240 C70 170, 230 170, 230 240 Z" fill="%23047857"/><text x="150" y="275" font-size="16" fill="white" text-anchor="middle" font-family="sans-serif">Imad Selfie Check-In</text></svg>', 
        status: 'verified', 
        createdAt: '2026-08-10 08:28:00' 
      },
      { 
        id: 'att-07', 
        employeeId: 'emp-02', 
        name: 'دارکۆ حەیدەر حسێن', 
        type: 'هاتن (Check In)', 
        time: '2026-08-13 08:25:10', 
        distance: 'داخل کۆمپانیا (12m)', 
        selfieUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 300 300"><rect width="300" height="300" fill="%231e293b"/><circle cx="150" cy="110" r="50" fill="%2338bdf8"/><path d="M70 240 C70 170, 230 170, 230 240 Z" fill="%230284c7"/><text x="150" y="275" font-size="16" fill="white" text-anchor="middle" font-family="sans-serif">Darko Selfie Check-In</text></svg>', 
        status: 'verified', 
        createdAt: '2026-08-13 08:25:10' 
      },
      { 
        id: 'att-08', 
        employeeId: 'emp-05', 
        name: 'عیماد سەباح نوری', 
        type: 'هاتن (Check In)', 
        time: '2026-08-13 08:30:00', 
        distance: 'داخل کۆمپانیا (18m)', 
        selfieUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 300 300"><rect width="300" height="300" fill="%231e293b"/><circle cx="150" cy="110" r="50" fill="%2310b981"/><path d="M70 240 C70 170, 230 170, 230 240 Z" fill="%23047857"/><text x="150" y="275" font-size="16" fill="white" text-anchor="middle" font-family="sans-serif">Imad Selfie Check-In</text></svg>', 
        status: 'verified', 
      ...
      { 
        ...
        type: 'هاتن (Check In)', 
        time: '2026-08-13 08:15:00', 
        distance: 'داخل کۆمپانیا (5m)', 
        selfieUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 300 300"><rect width="300" height="300" fill="%231e293b"/><circle cx="150" cy="110" r="50" fill="%23f59e0b"/><path d="M70 240 C70 170, 230 170, 230 240 Z" fill="%23d97706"/><text x="150" y="275" font-size="16" fill="white" text-anchor="middle" font-family="sans-serif">Sahand Selfie Check-In</text></svg>', 
        status: 'verified', 
