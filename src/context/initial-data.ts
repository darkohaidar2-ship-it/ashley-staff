...
export const initialData: any = {
    ...
    employees: [
      { id: 'emp-01', name: 'Darko (دارکۆ)', employeeId: '01', role: 'Super Manager', createdAt: '2023-01-01T00:00:00.000Z', isActive: true, password: '000' },
      { id: 'emp-02', name: 'کارۆخ مەحمود', employeeId: '02', role: 'Manager', createdAt: '2023-02-01T00:00:00.000Z', isActive: true, password: '1234' },
      { id: 'emp-03', name: 'دیار ئەحمەد', employeeId: '03', role: 'Employee Supervisor', createdAt: '2023-03-01T00:00:00.000Z', isActive: true, password: '1111' },
      { id: 'emp-04', name: 'سۆران عەلی', employeeId: '04', role: 'Transport Supervisor', createdAt: '2023-04-01T00:00:00.000Z', isActive: true, password: '2222' },
      { id: 'emp-05', name: 'ئاریان حەمە', employeeId: '05', role: 'Employee', createdAt: '2023-05-01T00:00:00.000Z', isActive: true, password: '3333' },
      { id: 'emp-06', name: 'هێمن عوسمان', employeeId: '06', role: 'Employee', createdAt: '2023-06-01T00:00:00.000Z', isActive: true, password: '4444' },
    ],
    excelFiles: [],
    items: [],
    locations: [],
