...
export function AdminDashboardWorkspace() {
  ...
  return (
    <div className="min-h-screen bg-[#f2f2f7] dark:bg-[#1c1c1e] text-slate-900 dark:text-white p-3 sm:p-5 lg:p-6 dir-rtl font-sans space-y-5" dir="rtl">
      ...
      {/* 🧭 UNIFIED NAVIGATION PILLS (VIEWS + CANONICAL MODULE LINKS) */}
      <nav className="flex items-center gap-1.5 p-1.5 bg-white/80 dark:bg-[#2c2c2e]/80 rounded-[20px] border border-slate-200/80 dark:border-white/5 shadow-xs overflow-x-auto">
        {/* 1. 31-Day Matrix View */}
        <button
          type="button"
        ...
        >
          ...
          <span>📅 ئامادەبوونی ڕۆژانە (Daily)</span>
        </button>

        <div className="h-5 w-px bg-slate-200 dark:bg-white/10 mx-1 shrink-0"></div>

        {/* 3. Direct Link: Employees */}
        <Link
          href="/employees"
          className="px-3.5 py-2 rounded-xl text-xs font-bold text-slate-700 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-blue-950/30 hover:text-[#007AFF] transition-all flex items-center gap-1.5 whitespace-nowrap"
        >
        ...
        {/* 4. Direct Link: Expenses */}
        <Link
          href="/ashley-expenses"
          className="px-3.5 py-2 rounded-xl text-xs font-bold text-slate-700 dark:text-slate-300 hover:bg-emerald-50 dark:hover:bg-emerald-950/30 hover:text-emerald-600 transition-all flex items-center gap-1.5 whitespace-nowrap"
        >
          <DollarSign className="w-3.5 h-3.5 text-emerald-500" />
          <span>مەسروفات و دارایی</span>
          <ExternalLink className="w-3 h-3 opacity-40" />
        </Link>

        {/* 5. Direct Link: Overtime */}
        <Link
          href="/overtime"
          className="px-3.5 py-2 rounded-xl text-xs font-bold text-slate-700 dark:text-slate-300 hover:bg-amber-50 dark:hover:bg-amber-950/30 hover:text-amber-600 transition-all flex items-center gap-1.5 whitespace-nowrap"
        >
          <Clock className="w-3.5 h-3.5 text-amber-500" />
          <span>کاتی زیادە (ئیزافە)</span>
          <ExternalLink className="w-3 h-3 opacity-40" />
        </Link>

        {/* 6. Direct Link: GPS Geofence */}
        <Link
          href="/gps"
          className="px-3.5 py-2 rounded-xl text-xs font-bold text-slate-700 dark:text-slate-300 hover:bg-cyan-50 dark:hover:bg-cyan-950/30 hover:text-cyan-600 transition-all flex items-center gap-1.5 whitespace-nowrap"
        >
          <MapPin className="w-3.5 h-3.5 text-cyan-500" />
          <span>نەخشەی شوێنەکان (GPS)</span>
          <ExternalLink className="w-3 h-3 opacity-40" />
        </Link>

        {/* 7. Direct Link: Settings (Corporate Identity & Logos) */}
        <Link
          href="/settings"
          className="px-3.5 py-2 rounded-xl text-xs font-bold text-slate-700 dark:text-slate-300 hover:bg-purple-50 dark:hover:bg-purple-950/30 hover:text-purple-600 transition-all flex items-center gap-1.5 whitespace-nowrap"
        >
